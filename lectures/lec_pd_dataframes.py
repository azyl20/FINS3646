...
This is True if the index is sorted in ascending order and False if not. Series also 
includes an is_monotonic_decreasing attribute that allows us to see if the index is 
sorted in descending order, returning True when it is.
'''
